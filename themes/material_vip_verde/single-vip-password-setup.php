	...
	<div class="content content_int">
		<div class="menu_navegacion">
			<ul>
				...
				<li><?php echo __('[:es]Establece tu contraseña[:en]Set up your password[:]'); ?></li>
			</ul>
		</div>
		<section>
			<div class="section_int ">
				<div class="texto texto_resgistro">
					<h2><?php echo __('[:es]Establece tu contraseña[:en]Set up your password[:]'); ?></h2>
				</div>
				<div class="clear"></div>
			</div>
			...
			?>
				...
				<?php echo ($mensaje_invalido=='')?'<p>'.$mensaje_info.'</p>':'<p class="mensaje_error_vip">'.$mensaje_invalido.'</p>'; ?>
					...
					<form action="" method="post" name="form_establece_password" >
						...
						<input type="submit" name="" value="<?php echo __('[:es]Establecer mi contraseña[:en]Set up my password[:]'); ?>" id="submitBot">
					</form>
				<?php }else{ ?>
