...
$wpdb->update('wp_users_vip', array( 
    ...
    echo "\n";
                if($spam == '' && $users_vip_aprobar_email != '' ){
                    ...
                    <p style="text-align: right;"><b>Isa Castilla</b><br><b>Directora de Relaciones VIP</b></p>
                    <p style="text-align: right;"><b>Alejandro Trigos</b><br><b>Coordinador del Programa VIP</b></p>
