...
<div class="wrapper taxonomy_programas_gral">
	<div class="content content_int">
		...
		<!-- <div class="image img_05" data-stellar-ratio="0.5"><img src="<?php echo get_template_directory_uri(); ?>/img/fondo/03.png" ></div> -->
...
<?php
$set_dias=get_terms( array('taxonomy' => $taxonomy,'order' => 'DESC','orderby' => 'term_id','parent'=>$term_programa->term_id));
...
<p>
<?php 
$set_years_olds=get_terms(array('taxonomy'=> $taxonomy,'order'=> 'DESC','exclude'=> $term_programa->term_id,'parent'=>0));
